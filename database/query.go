...
var (
	...
	VehiclePartTable  = "VehiclePart"
	RelatedPartsTable = "RelatedPart"
)
...
// // select y.year, ma.make, mo.model, s.style, p.*
// // from VehicleNew v
// // join YearNew y on y.yearID = v.yearID
// // join MakeNew ma on ma.makeID = v.makeID
// // join ModelNew mo on mo.modelID = v.modelID
// // join StyleNew s on s.styleID = v.styleID
// // join VehiclePartNew vp on vp.vehicleID = v.vehicleID
